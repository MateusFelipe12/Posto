<?php
        ...
        switch($_GET['action']){
            case 'add':
                ...
                if(
                    ...
                    !isset($value) || 
                    !strlen(trim($value))
                ) response(['js'=>'$.toast(\'Preencha todos os campos do formulário!\',\'error\')']);
            ...
            case 'edit':
                ...
                if( $result['code'] ){
                    ...
                    response(['js'=>'console.log(\''.$sql.'\');'.$js]);
            ...
            case 'delete':
                ...
                if( !isset( $code ) ||  !is_numeric( $code ) ) response(['js'=>'$.toast(\'Ocorreu um erro, recarregue a página!\',\'error\')']);
    ...
    function getListProduct($permission='read'){
